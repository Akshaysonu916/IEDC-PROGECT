...
<body>
    <header>
      ...
      <div class="main-content-header">
          ...
          <table class="table1">
              <span> <h4 class="h_3">First series Exam (A)</h4></span>
             <tr>
                <th>CP</th>   <th> English </th> <th>Math</th>
             </tr>
             <tr>
                 <td>
                <input type='text' name='CP1' value="<?php echo $data['u_CP1']; ?>" class="th" required/></td>
          ...
          <span> <h4 class="h3">Second series Exam(B)</h4> </span>
         <table class="table4">
             <tr>
               <th>CP</th>   <th> English </th> <th>Math</th>
             </tr>
             <tr>
                 <td><input type='text' name='CP2' value="<?php echo $data['u_CP2']; ?> " class="th" required/></td>
